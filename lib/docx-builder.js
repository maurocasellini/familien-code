  ...
  de: {
    ...
    groups: [
      ['Numerologie, deine Zahlen', [
        ...
        ['Persönliches Jahr (PJ)', 'Ein Jahres-Zyklus von Geburtstag zu Geburtstag, der die Grundstimmung des Jahres färbt.'],
  ...
  en: {
    ...
    groups: [
      ['Numerology, your numbers', [
        ...
        ['Personal Year (PY)', 'A yearly cycle from birthday to birthday that colours the mood of the year.'],
  ...
  pt: {
    ...
    groups: [
      ['Numerologia, os teus números', [
        ...
        ['Ano Pessoal (AP)', 'Um ciclo anual de aniversário a aniversário que colore o clima do ano.'],
